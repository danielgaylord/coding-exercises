...
def extended_polymerization(file, iterations):
...
class Day14Tests(unittest.TestCase):
    def test_extended_polymerization_part1(self):
        self.assertEqual(extended_polymerization('Advent of Code/test.txt', 10), 1588)
    
    def test_extended_polymerization_part2(self):
        self.assertEqual(extended_polymerization('Advent of Code/test.txt', 40), 2188189693529)

if __name__ == "__main__":
    #unittest.main(verbosity=2)
    
    # Part 1 solution
    print(extended_polymerization('Advent of Code/2021-Day14.txt', 10))
    
    # Part 2 solution
    print(extended_polymerization('Advent of Code/2021-Day14.txt', 40))
